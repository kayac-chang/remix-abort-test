...
var import_jsx_dev_runtime3 = require("react/jsx-dev-runtime"), meta = () => [{ title: "New Remix App" }], sleep = (ms) => new Promise((resolve) => setTimeout(resolve, ms));
async function loader() {
  return await new Promise((resolve, reject) => {
    let controller = new AbortController(), req = new Request("https://dev.com/slow", {
      method: "POST",
      body: JSON.stringify({ a: 1 })
    });
    sleep(1e3).then(() => controller.abort()).catch(reject), fetch(req, { signal: controller.signal }).then(resolve).catch(reject);
  }).then((res) => res.json()).catch(console.error), null;
}
function Index() {
...
var assets_manifest_default = { version: "80c8f7ae", entry: { module: "/build/entry.client-XLCPTT5O.js", imports: ["/build/_shared/chunk-GZMNNEXQ.js", "/build/_shared/chunk-EETRBLDB.js"] }, routes: { root: { id: "root", parentId: void 0, path: "", index: void 0, caseSensitive: void 0, module: "/build/root-C4TTBS5H.js", imports: void 0, hasAction: !1, hasLoader: !1, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/_index": { id: "routes/_index", parentId: "root", path: void 0, index: !0, caseSensitive: void 0, module: "/build/routes/_index-A6F577PO.js", imports: void 0, hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 } }, cssBundleHref: void 0, hmr: void 0, url: "/build/manifest-80C8F7AE.js" };
